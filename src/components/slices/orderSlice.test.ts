...
const ERROR_POST_ORDER = 'Ошибка оформления заказа';
const ERROR_FETCH_ORDER = 'Ошибка при загрузке заказа';
// Моковые данные
...
describe('Тесты orderSlice', () => {
    ...
    it('тест postOrderBurger.rejected', () => {
        ...
        const stateCheck: TOrderSlice = { ...initialState, error: ERROR_POST_ORDER };
    ...
    it('тест fetchOrderByNumber.rejected', () => {
        ...
        const stateTest = orderSlice.reducer(initialState, action);
        const stateCheck: TOrderSlice = { ...initialState, orderById: ERROR_FETCH_ORDER };
        expect(stateTest).toEqual(stateCheck);
    });
    ...
    it('тест getPlacedOrders.rejected', () => {
        ...
        const stateTest = orderSlice.reducer(initialState, action);
        const stateCheck: TOrderSlice = { ...initialState, error: ERROR_FETCH_ORDER };
        expect(stateTest).toEqual(stateCheck);
    });
